...
namespace CMSWindowsFormsApp1 {
    ...
    public partial class CMSDBDataSet : global::System.Data.DataSet {
        ...
        public partial class tblJobDetailsDataTable : global::System.Data.TypedTableBase<tblJobDetailsRow> {
            ...
            private global::System.Data.DataColumn columnJabDate;
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public global::System.Data.DataColumn JabDateColumn {
                get {
                    return this.columnJabDate;
                }
            }
            ...
            internal void InitVars() {
                this.columnCarNo = base.Columns["CarNo"];
                this.columnJabDate = base.Columns["JabDate"];
            ...
            private void InitClass() {
                this.columnCarNo = new global::System.Data.DataColumn("CarNo", typeof(string), null, global::System.Data.MappingType.Element);
                base.Columns.Add(this.columnCarNo);
                this.columnJabDate = new global::System.Data.DataColumn("JabDate", typeof(global::System.DateTime), null, global::System.Data.MappingType.Element);
                base.Columns.Add(this.columnJabDate);
                ...
                this.columnJabDate.AllowDBNull = false;
        ...
        public partial class tblJobDetailsRow : global::System.Data.DataRow {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public System.DateTime JabDate {
                get {
                    return ((global::System.DateTime)(this[this.tabletblJobDetails.JabDateColumn]));
                }
                set {
                    this[this.tabletblJobDetails.JabDateColumn] = value;
                }
            }
...
SELECT CarNo, Name, Address, Make FROM tblCustomer WHERE (CarNo = @CarNo)";
    ...
    public partial class tblJobDetailsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("CarNo", "CarNo");
            tableMapping.ColumnMappings.Add("JabDate", "JabDate");
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[tblJobDetails] ([CarNo], [JabDate], [WorkerID], [KMs], [Tunning], [Alignment], [Balancing], [Tires], [Weights], [OilChanged], [OilQty], [OilFilter], [GearOil], [GearOilQty], [Point], [Condenser], [Plug], [PlugQty], [FuelFilter], [AirFilter], [Remarks]) VALUES (@CarNo, @JabDate, @WorkerID, @KMs, @Tunning, @Alignment, @Balancing, @Tires, @Weights, @OilChanged, @OilQty, @OilFilter, @GearOil, @GearOilQty, @Point, @Condenser, @Plug, @PlugQty, @FuelFilter, @AirFilter, @Remarks)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@CarNo", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "CarNo", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@JabDate", global::System.Data.SqlDbType.DateTime, 0, global::System.Data.ParameterDirection.Input, 0, 0, "JabDate", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT CarNo, JabDate, WorkerID, KMs, Tunning, Alignment, Balancing, Tires, Weigh" +
        ...
        public virtual int Insert(
            ...
            this.Adapter.InsertCommand.Parameters[1].Value = ((System.DateTime)(JabDate));
    ...
    public partial class tblWorkerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT WorkerID, Name\r\nFROM   tblWorker";
        ...
        public virtual int FillBy(CMSDBDataSet.tblWorkerDataTable dataTable) {
        ...
        public virtual CMSDBDataSet.tblWorkerDataTable GetDataBy() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            CMSDBDataSet.tblWorkerDataTable dataTable = new CMSDBDataSet.tblWorkerDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
